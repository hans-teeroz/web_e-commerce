        ...
        <div class="row">
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    <a href="?type=inventory" type="button" class="{{Request::get('type') == "inventory" || !Request::get('type') ? "btn btn-danger" : "btn btn-default"}}"><i class="fa fa-home" aria-hidden="true"> &nbsp; Hàng tồn</i></a>
                    <a href="?type=selling" type="button" class="{{Request::get('type') == "selling" ? "btn btn-danger" : "btn btn-default"}}"><i class="fa fa-fire" aria-hidden="true"> &nbsp; Bán chạy</i></a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>Số lượng đã bán: {{$product->pro_pay}} </li>
